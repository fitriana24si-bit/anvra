          ...
          >
            ...
            >
              <div>
                ...
                >
                  {customersData.length.toLocaleString()}
                </div>
                <div
                  style={{
                    fontSize: 13,
      ...
      >
        ...
        >
          <span style={{ fontSize: 13, color: "#6B7280" }}>
            Menampilkan{" "}
            <strong style={{ color: "#111827" }}>{filtered.length}</strong> dari{" "}
            {customersData.length} pelanggan
          </span>
        </div>
                ...
                >
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    ...
                    >
                      ...
                      {/* 🔥 TAMBAHAN: Link ke halaman detail customer */}
                      <Link
                        to={`/customers/${c.id}`}
                        style={{
                          fontWeight: 600,
